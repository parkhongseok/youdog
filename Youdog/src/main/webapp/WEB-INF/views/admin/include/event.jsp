			...
			<div class="owl-carousel pricing-carousel">
				<div class="pricing-item">
					<div class="rounded pricing-content ">
						<div
							class="bg-light rounded-top border-3 border-bottom border-primary-- p-2">
							<h5 class="text-primary-- text-uppercase m-0 text-center ">Hot
								Event</h5>
						</div>
						<div class="p-4 bg-white-- rounded-bottom">
							<div class="">
								<img src="/youdog/resources/assets/img/event-1.png"
									class="img-fluid rounded" alt="">
							</div>
							<div
								class="pt-3 d-flex align-items-center justify-content-between ">
								<div class="text-darkgray--">
									<p>Welcome to "Ansan". Hello world !!</p>
								</div>
								<div>
									<a
										class="btn btn-primary-- btn-primary-outline-0 rounded-pill px-4">
										more</a>
								</div>
							</div>
						</div>
				...
				<div class="pricing-item">
					<div class="rounded pricing-content ">
						...
						<div class="p-4 bg-white-- rounded-bottom">
							<div>
								<img src="/youdog/resources/assets/img/event-2.png"
									class="img-fluid rounded" alt="">
							</div>
							<div
								class="pt-3 d-flex align-items-center justify-content-between ">
				...
				<div class="pricing-item">
					<div class="rounded pricing-content ">
						...
						<div class="p-4 bg-white-- rounded-bottom">
							<div>
								<img src="/youdog/resources/assets/img/event-3.png"
									class="img-fluid rounded" alt="">
							</div>
							<div
								class="pt-3 d-flex align-items-center justify-content-between ">
				...
				<div class="pricing-item">
					<div class="rounded pricing-content ">
						...
						<div class="p-4 bg-white-- rounded-bottom">
							<div>
								<img src="/youdog/resources/assets/img/event-4.png"
									class="img-fluid rounded" alt="">
							</div>
							<div
								class="pt-3 d-flex align-items-center justify-content-between ">
...
<div class="logo-lg-- m-auto">
			<img src="/youdog/resources/assets/img/logo3.png" class="img-fluid my-2" alt=""> 
		</div>
			...
			<div class="owl-carousel pricing-carousel">
				<div class="pricing-item">
					<div class="rounded pricing-content ">
						...
						<div class="p-4 bg-white-- rounded-bottom">
							<div>
								<img src="/youdog/resources/assets/img/event-9.jpg"
									class="img-fluid rounded" alt="">
							</div>
							<div
								class="pt-3 d-flex align-items-center justify-content-between ">
				...
				<div class="pricing-item">
					<div class="rounded pricing-content ">
						...
						<div class="p-4 bg-white-- rounded-bottom">
							<div>
								<img src="/youdog/resources/assets/img/event-10.jpg"
									class="img-fluid rounded" alt="">
							</div>
							<div
								class="pt-3 d-flex align-items-center justify-content-between ">
				...
				<div class="pricing-item">
					<div class="rounded pricing-content ">
						...
						<div class="p-4 bg-white-- rounded-bottom">
							<div>
								<img src="/youdog/resources/assets/img/event-11.jpg"
									class="img-fluid rounded" alt="">
							</div>
							<div
								class="pt-3 d-flex align-items-center justify-content-between ">
				...
				<div class="pricing-item">
					<div class="rounded pricing-content ">
						...
						<div class="p-4 bg-white-- rounded-bottom">
							<div>
								<img src="/youdog/resources/assets/img/event-12.jpg"
									class="img-fluid rounded" alt="">
							</div>
							<div
								class="pt-3 d-flex align-items-center justify-content-between ">
			...
			<div class="owl-carousel pricing-carousel">
				<div class="pricing-item">
					<div class="rounded pricing-content ">
						...
						<div class="p-4 bg-white-- rounded-bottom">
							<div>
								<img src="/youdog/resources/assets/img/event-5.png"
									class="img-fluid rounded" alt="">
							</div>
							<div
								class="pt-3 d-flex align-items-center justify-content-between ">
				...
				<div class="pricing-item">
					<div class="rounded pricing-content ">
						...
						<div class="p-4 bg-white-- rounded-bottom">
							<div>
								<img src="/youdog/resources/assets/img/event-6.png"
									class="img-fluid rounded" alt="">
							</div>
							<div
								class="pt-3 d-flex align-items-center justify-content-between ">
				...
				<div class="pricing-item">
					<div class="rounded pricing-content ">
						...
						<div class="p-4 bg-white-- rounded-bottom">
							<div>
								<img src="/youdog/resources/assets/img/event-7.jpg"
									class="img-fluid rounded" alt="">
							</div>
							<div
								class="pt-3 d-flex align-items-center justify-content-between ">
				...
				<div class="pricing-item">
					<div class="rounded pricing-content ">
						...
						<div class="p-4 bg-white-- rounded-bottom">
							<div>
								<img src="/youdog/resources/assets/img/event-8.jpg"
									class="img-fluid rounded" alt="">
							</div>
							<div
								class="pt-3 d-flex align-items-center justify-content-between ">
