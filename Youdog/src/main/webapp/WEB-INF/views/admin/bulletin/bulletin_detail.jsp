		...
		<div class="container-fluid py-5">
			...
			<div>
				...
				<div class="row">
					...
					<div class="col-6">
					<c:set var="loginedAdminMemberVo" value="${sessionScope.loginedAdminMemberVo}" />

					    <!-- 로그인이 되어 있는 경우-->
					   
					<c:if test="${loginedAdminMemberVo != null && loginedAdminMemberVo.getAdmin_no() == bulletinVo.getBulletin_writer_no()}"> 
		
					    <!-- session에 담긴 loginedAdminMemberVo의 값이 null이 아니면 아래 표시 -->
					    ...
					    <!-- 로그인이 되어 안되어있는 경우-->
						<c:if test="${loginedAdminMemberVo == null or loginedAdminMemberVo.getAdmin_no() != bulletinVo.getBulletin_writer_no()}"> 
					
					    <!-- session에 담긴 loginedAdminMemberVo의 값이 null이면 아래 표시 -->
					    <p class="text-right px-2" style="text-align: right; margin-bottom: 0;">
					        신고하기 | 스크랩
					    </p>
				 </c:if>
