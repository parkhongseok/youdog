	...
	<div class="container-fluid sticky-top px-0">
			...
			<div class="container px-0">
				<div class="row align-items-center">
					...
					<div class="col-lg-4">
						...
						<a href="/youdog/admin"
                        class="me-3 btn-square border rounded-circle nav-fill text-secondary--">A</a>
							<a href="#"
		...
		<div class="container-fluid bg-light">
			<div class="container px-0">
				<nav class="navbar navbar-light navbar-expand-xl">
					<a href="<c:url value='/user' />" class="navbar-brand"> <img
					...
					<div class="collapse navbar-collapse bg-light py-3"
						...
						<div class="navbar-nav mx-auto border-top">
							...
							<a href="<c:url value='/place' />" class="nav-item nav-link">Place</a>
							<a href="<c:url value='/event' />" class="nav-item nav-link">Event</a>
							<a href="<c:url value='/bulletin'/>" class="nav-item nav-link ">Board</a>
							<a href="<c:url value='/contact'/>" class="nav-item nav-link">Contact	Us</a>
						</div>
		...
		%>
							<div class="btn btn-primary-- btn-primary-outline-0 rounded-pill  px-4 ms-4 nav-item dropdown">
								<a href="#" class="nav-link dropdown-toggle text-white"
									data-bs-toggle="dropdown">${loginedUserMemberVo.user_name}님</a>
								<div class="dropdown-menu m-0 btn-secondary-- rounded-0">
									<a href="<c:url value='/user/member/modifyAccountForm'/>" class="text-center  dropdown-item">회원정보 수정</a>
									<a href="<c:url value='/user/wishlist'/>" class="text-center dropdown-item">찜목록</a>
									<a href="<c:url value='/404'/>" class="text-center  dropdown-item"> </a>
									<a href="<c:url value='/user/member/logoutConfirm'/>" class="text-center dropdown-item">로그아웃</a>
								</div>
							</div>
		...
		%>
								<div style="width: 7rem;" class="btn btn-primary-- btn-primary-outline-0 rounded-pill">
									<a href="<c:url value='/user/member/loginForm'/>" class="text-white">로그인</a>
								</div>
								<div style="width: 7rem;" class="btn btn-primary-- btn-primary-outline-0 rounded-pill mx-3">								
									<a href="<c:url value='/user/member/createAccountForm'/>" class="text-white"> 회원가입 </a>
								</div>
