...
public class AdminBulletinController {
	...
	public String writePage(HttpSession session) {
		...
		String nextPage = "admin/buㄴlletin/bulletin_write";
	...
	public String modifyBulletinConfirm(@ModelAttribute BulletinVo bulletinVo, Model model) {
		logger.info("modifyBulletinConfirm");
		BulletinVo bltVo = adminBulletinService.detailBulletin(bulletinVo.getBulletin_no());
		model.addAttribute("bulletin", bltVo);

		return "/admin/bulletin/bulletin_detail";
	}
